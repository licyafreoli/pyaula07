...
def calcular_areas():
    while True:
        ...
        if opcao == "1":
            ...
            print(f"A área do retangulo é: {arearetangulo(num1, num2)}")
        elif opcao == '3':
            num1= float(input("digite o raio do circulo: "))
            print(f"A área do circulo é: {areacirculo(num1)}")
        elif opcao == '4':
            num1= float(input("digite o raio do circulo: "))
            print(f"A área do circulo é: {pericirculo (num1)}")
        elif opcao == '5':
            num1= float(input("digite o menor lado do retangulo: "))
            num2= float(input("digite o maior lado do retangulo: "))
            print(f"A área do retangulo é: {periretangulo(num1, num2)}")
        elif opcao == '6':
            num1= float(input("digite um lado do quadrado: "))
            print(f"A área do quadrado é: {periquadrado(num1)}")
        else:
